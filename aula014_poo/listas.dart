...
String lerData() {
  ...
  do {
    ...
    if (!exp.hasMatch(data)) {
      print('Formato inválido! Use DD-MM-YYYY. Ex: 15-02-2025');
    }
...
String lerHora() {
  ...
  do {
    ...
    if (!exp.hasMatch(hora)) {
      print('Formato inválido! Use HH:MM. Ex: 21:00');
    }
...
void main() {
  ...
  do {
    ...
    // faz com que o programa continue repetindo o menu enquanto a variável
    // opcao for diferente de 3.
  } while (opcao != 3);
}
